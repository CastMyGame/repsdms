...
public class PunishmentServiceTest {
    ...
    @Test
    void testSetUpPunishmentResponse() {
        // Arrange
        Student student = new Student();
        ...
        // Act
        PunishmentResponse response = punishmentService.setUpPunishmentResponse(punishment, student);

        // Assert
        assertEquals("parent@example.com", response.getParentToEmail());
        assertEquals("student@example.com", response.getStudentToEmail());
        assertEquals("teacher@example.com", response.getTeacherToEmail());
        assertEquals(punishment, response.getPunishment());
    }
